...
if __name__ == "__main__":
        ...
        CHECK_DIR  =  source+'/'+lon_region+'/'+lat_region+'/BOOTSTRAPPING_BLOCKS/block_evolution_29_days/days4/unfiltered_WA_fluxes/'
                ...
                if not os.path.exists(random_loc_dates):
                    ...
                    for blocking_days in range(4,20):
                                ...
                                if 'days%d'%(blocking_days) in blocking_details_day_wise:
                                            ...
                                            logging_object.write('Working on '+dest+'/unfiltered_WA_fluxes/')

                                      

                                            ###### Save unfiltered wave activity and wave activity fluxes ######
                                            BLOCK_window_list_Afull       = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['A_N'], \
                                            ...
                                            BLOCK_window_list_Ffull         = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F_adv_x']+\
                                            ...
                                            # BLOCK_window_list_F1full        = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F1_adv_x'], blocking_details=blocking_details,\
                                            #                                                         dest=dest+'/unfiltered_WA_fluxes/',name='BLOCK_window_list_F1_full_unfiltered',\
                                            #                                                         lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0,\
                                            #                                                         save_bootstrap_raw=False, percentiles=PERCENTILES )[0]

                                            # BLOCK_window_list_F2full        = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F2_adv_x'], blocking_details=blocking_details,\
                                            #                                                         dest=dest+'/unfiltered_WA_fluxes/',name='BLOCK_window_list_F2_full_unfiltered',\
                                            #                                                         lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0,\
                                            #                                                         save_bootstrap_raw=False, percentiles=PERCENTILES )[0]

                                            # BLOCK_window_list_F3full        = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_x'], blocking_details=blocking_details,\
                                            #                                                         dest=dest+'/unfiltered_WA_fluxes/', name='BLOCK_window_list_F3_full_unfiltered',\
                                            #                                                         lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0,\
                                            #                                                         save_bootstrap_raw=False, percentiles=PERCENTILES )[0]

                                            # BLOCK_window_list_F_EPy_full    = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_y'],   blocking_details=blocking_details,\
                                            #                                                         dest=dest+'/unfiltered_WA_fluxes/', name='BLOCK_window_list_F_EPy_full_unfiltered',\
                                            #                                                         lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0,\
                                            #                                                         save_bootstrap_raw=False, percentiles=PERCENTILES )[0]

                                            # BLOCK_window_list_F_EPz_full    = stats_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_z'],   blocking_details=blocking_details,\
