...
if __name__ == "__main__":
        ...
        CHECK_DIR  =  source+'/'+lon_region+'/'+lat_region+'/block_evolution_29_days/days4/u_v_pv_phi/'
        ...
        if os.path.exists(CHECK_DIR):   
                ...
                for blocking_days in range(4,20):
                            ...
                            if 'days%d'%(blocking_days) in blocking_details_day_wise:
                                        ...
                                        if not os.path.exists(dest+'/u_v_pv_phi/'):


                                                    BLOCK_window_list_Z300_full       = average_over_many_blocks(FIELD = geopotential_300_N_daily,   blocking_details=blocking_details,\
                                                    ...
                                                    BLOCK_window_list_U300_full       = average_over_many_blocks(FIELD = u_wind_300_N_daily,  blocking_details=blocking_details,\
                                                                                                             dest=dest+'/u_v_pv_phi/', name='BLOCK_window_list_U300_full',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]


                                                    BLOCK_window_list_V300_full       = average_over_many_blocks(FIELD = v_wind_300_N_daily,   blocking_details=blocking_details,\
                                                                                                             dest=dest+'/u_v_pv_phi/', name='BLOCK_window_list_V300_full',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]


                                                    BLOCK_window_list_PV300_full      = average_over_many_blocks(FIELD = potential_vorticity_300_N_daily,   blocking_details=blocking_details,\
                                                                                                             dest=dest+'/u_v_pv_phi/', name='BLOCK_window_list_PV300_full',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]


                                                    BLOCK_window_list_Uvert_full      = average_over_many_blocks(FIELD = U_N,   blocking_details=blocking_details,\
