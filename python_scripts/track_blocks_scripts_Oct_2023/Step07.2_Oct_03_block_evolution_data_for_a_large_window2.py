...
if __name__ == "__main__":
        ...
        CHECK_DIR  =  source+'/'+lon_region+'/'+lat_region+'/block_evolution_29_days/days4/unfiltered_WA_fluxes/'
        ...
        if os.path.exists(CHECK_DIR):   
                ...
                route  = '/data/pragallva/2023_repeat_ERA5/post_processing/filtered_parameters/unfiltered_Zsmooth15/'
                EP_and_advective_flux_convergence = h5saveload.load_dict_from_hdf5(route+'EPa_and_advective_flux_covergence.hdf5')
                EP_and_advective_fluxes           = h5saveload.load_dict_from_hdf5(route+'EPa_and_advective_fluxes.hdf5')
                ...
                for blocking_days in range(4,20):
                            ...
                            if 'days%d'%(blocking_days) in blocking_details_day_wise:
                                        ...
                                        if not os.path.exists(dest+'/unfiltered_WA_budget/'):

                                                    ########## Save unfiltered wave activity budget terms #############
                                                    BLOCK_window_list_dxFfull        = average_over_many_blocks(FIELD = (EP_and_advective_flux_convergence['dF_dx']), \
                                                                                                                dest=dest+'/unfiltered_WA_budget/', \
                                                                                                                blocking_details=blocking_details,\
                                                                                                                name='BLOCK_window_list_dxF_full_unfiltered',\
                                                                                                                lon_range = 60, lat_range = 15, time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dxF1full       = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dF1_adv_dx'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/',name='BLOCK_window_list_dxF1_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dxF2full       = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dF2_adv_dx'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/',name='BLOCK_window_list_dxF2_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dxF3full       = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dF_EPx_dx'],  blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/',name='BLOCK_window_list_dxF3_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dyEPyfull      = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dF_EPy_dy'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/',name='BLOCK_window_list_dyEPy_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dzEPzfull      = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dF_EPz_dz'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/',name='BLOCK_window_list_dzEPz_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_dAdtfull       = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['dA_dt'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/', name='BLOCK_window_list_dAdt_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]           

                                                    BLOCK_window_list_residualfull       = average_over_many_blocks(FIELD = EP_and_advective_flux_convergence['residual'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_budget/', name='BLOCK_window_list_residual_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]           

                                        else:
                                                logging_object.write('Already exists  --> \n '+dest+'/unfiltered_WA_budget/')


                                        if not os.path.exists(dest+'/unfiltered_WA_fluxes/'):                                        


                                                    ###### Save unfiltered wave activity and wave activity fluxes ######
                                                    BLOCK_window_list_Afull       = average_over_many_blocks(FIELD = EP_and_advective_fluxes['A_N'], \
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/', blocking_details=blocking_details,\
                                                                                                             name='BLOCK_window_list_A_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_Ffull       = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F_adv_x']+\
                                                                                                                     EP_and_advective_fluxes['F_EP_x'] ,  blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/',name='BLOCK_window_list_F_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_F1full      = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F1_adv_x'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/',name='BLOCK_window_list_F1_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_F2full      = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F2_adv_x'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/',name='BLOCK_window_list_F2_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_F3full         = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_x'], blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/', name='BLOCK_window_list_F3_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_F_EPy_full     = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_y'],   blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/', name='BLOCK_window_list_F_EPy_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]

                                                    BLOCK_window_list_F_EPz_full     = average_over_many_blocks(FIELD = EP_and_advective_fluxes['F_EP_z'],   blocking_details=blocking_details,\
                                                                                                             dest=dest+'/unfiltered_WA_fluxes/', name='BLOCK_window_list_F_EPz_full_unfiltered',\
                                                                                                             lon_range = 60, lat_range = 15,  time_range_plus = Tp, time_range_minus = Tm, time_difference=0 )[0]
